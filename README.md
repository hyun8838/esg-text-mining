...
* LDA k=6 토픽에서 의류 계열 집중 토픽(T1, avg_prob 0.758) 가장 뚜렷한 주제 집중도 확인 — T5(기술/개발)는 avg_prob 0.648로 범학과적 혼합 토픽 성격
...
* '법'·'물' 키워드 전면 제외 — FP 비율이 높아 제외했으나 '물 부족'·'물 절약' 등 E 범주 표현도 함께 누락되는 false negative 발생
